...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4>Xin chào <span style="text-decoration: underline">{{Auth::user()->name}}</span> đến với <i class="icon ion-heart"></i> của phần mềm của chúng tôi</h4>
            <ol class="breadcrumb">
        ...
        <!-- /.content -->
        <!-- Test -->
        <table id="table-test" cellpadding="10" cellspacing="10" align="center" width="500px" border="1px" bgcolor="blue" style="text-align: center;font-weight: bold">
            <tr>
                <td colspan="4" style="height: 50px; text-transform: capitalize;color: #ffffff; font-size: 18px" bgcolor="green">Bảng xếp hạng bóng đá hạng anh</td>
            </tr>
            <tr bgcolor="yellow">
                <td>STT</td>
                <td>Câu lạc bộ</td>
